...
dso <- read.csv("DSO2001.csv")
gtf <- read.csv("GTF2001.csv")
...
dso <- dso[,c("Date_UTC","dbn_nez","dbn_geo","dbe_nez","dbe_geo","dbz_nez","dbz_geo")]
gtf <- gtf[,c("Date_UTC","dbn_nez","dbn_geo","dbe_nez","dbe_geo","dbz_nez","dbz_geo")]
